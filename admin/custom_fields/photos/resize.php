...
class CropAvatar {
  ...
  private function setDst() {
	$info = pathinfo(realpath($this->src));
	$this -> dst = $info['dirname'] . "/" . $info['filename'] . ".png";
  }
  ...
  public function getResult() {
	...
	{
		$photo = str_replace(realpath(dirname(dirname(dirname(__DIR__)))), "",$this -> dst);
		
		$custom_field_photos = new custom_field_photos();
		$custom_field_photos->manual_init();
		$custom_field_photos->update_path($photo, $_POST['id']);
